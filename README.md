...
Here is a wiring diagram for how to connect the whole system together. The system is simple and should be plug and play, the motor connects to the controller, the controller connects to the battery pack. controller is plug-and-play and requires no custom programming
...
**Everything with cost of shipping and all is $192**
